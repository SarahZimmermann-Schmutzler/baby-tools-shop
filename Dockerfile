...
ENTRYPOINT ["/bin/sh", "-c", "python babyshop_app/manage.py migrate && python babyshop_app/babyshop/manage.py createsupe && python babyshop_app/manage.py runserver 0.0.0.0:8000"]
